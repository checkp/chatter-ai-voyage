...
import SortableAgent from './SortableAgent';
...
const AIStatusBar: React.FC<AIStatusBarProps> = ({ 
  ...
  return (
    <>
      <div className="theme-surface border-b theme-border px-4 py-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium theme-text-muted">AI Agents:</span>
