...
import { Brain, Users, MessageSquare, Zap, ArrowRight, Bot, Eye, Grid3X3, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/50 to-background">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={() => window.location.href = '/auth'} className="text-lg px-8 py-6">
              Experience AI Conductor
              <Brain className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" onClick={() => window.location.href = '/auth'} className="text-lg px-8 py-6">
              View Demo
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <Button size="lg" onClick={() => window.location.href = '/auth'} className="text-lg px-12 py-6">
